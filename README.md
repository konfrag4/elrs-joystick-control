This fork does not work on its own. It is modified in a way so that it can be used by [DroneCtrl](https://github.com/konfrag4/DroneCtrl) - a program that makes any FPV drone autonomous and provides an easy way to program your drone.
